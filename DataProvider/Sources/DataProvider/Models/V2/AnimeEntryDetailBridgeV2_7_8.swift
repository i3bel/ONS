//
//  AnimeEntryDetailBridgeV2_7_8.swift
//  DataProvider
//
...
extension SchemaV2_7_8.AnimeEntryDetail {
    public convenience init(from dto: AnimeEntryDetailDTO) {
        self.init(
            ...
            seasons: dto.seasons.map(SchemaV2_7_8.AnimeEntrySeasonSummary.init(from:)),
    ...
    public convenience init(fromLegacy payload: LegacyAnimeEntryDetailPayload) {
        self.init(
            ...
            staff: [],
            seasons: payload.seasons.map(SchemaV2_7_8.AnimeEntrySeasonSummary.init(fromLegacy:)),
    ...
    private func replaceSeasons(with dtos: [AnimeEntrySeasonSummaryDTO]) {
        ...
        seasons = dtos.map(SchemaV2_7_8.AnimeEntrySeasonSummary.init(from:))
    ...
    private static func makeCharacters(
        ...
        dtos.enumerated().map {
            SchemaV2_7_8.AnimeEntryCharacter(from: $0.element, displayOrder: $0.offset)
        }
    }
    ...
    private static func makeCharacters(
        ...
        payloads.enumerated().map {
            SchemaV2_7_8.AnimeEntryCharacter(fromLegacy: $0.element, displayOrder: $0.offset)
        }
    }
    ...
    private static func makeStaff(
        ...
        dtos.enumerated().map {
            SchemaV2_7_8.AnimeEntryStaff(from: $0.element, displayOrder: $0.offset)
        }
    }
    ...
    private static func makeEpisodes(
        ...
        dtos.enumerated().map {
            SchemaV2_7_8.AnimeEntryEpisodeSummary(from: $0.element, displayOrder: $0.offset)
        }
    }
    ...
    private static func makeEpisodes(
        ...
        payloads.enumerated().map {
            SchemaV2_7_8.AnimeEntryEpisodeSummary(fromLegacy: $0.element, displayOrder: $0.offset)
        }
    }
}
