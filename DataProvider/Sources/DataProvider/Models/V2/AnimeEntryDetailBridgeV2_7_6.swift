//
//  AnimeEntryDetailBridgeV2_7_6.swift
//  DataProvider
//
...
extension SchemaV2_7_6.AnimeEntryDetail {
    public convenience init(from dto: AnimeEntryDetailDTO) {
        self.init(
            ...
            seasons: dto.seasons.map(SchemaV2_7_6.AnimeEntrySeasonSummary.init(from:)),
    ...
    public convenience init(fromLegacy payload: LegacyAnimeEntryDetailPayload) {
        self.init(
            ...
            staff: [],
            seasons: payload.seasons.map(SchemaV2_7_6.AnimeEntrySeasonSummary.init(fromLegacy:)),
    ...
    private func replaceSeasons(with dtos: [AnimeEntrySeasonSummaryDTO]) {
        ...
        seasons = dtos.map(SchemaV2_7_6.AnimeEntrySeasonSummary.init(from:))
    ...
    ) -> [SchemaV2_7_6.AnimeEntryCharacter] {
        dtos.enumerated().map {
            SchemaV2_7_6.AnimeEntryCharacter(from: $0.element, displayOrder: $0.offset)
        }
    }
    ...
    private static func makeCharacters(
        ...
        payloads.enumerated().map {
            SchemaV2_7_6.AnimeEntryCharacter(fromLegacy: $0.element, displayOrder: $0.offset)
        }
    }

    private static func makeStaff(
        from dtos: [AnimeEntryStaffDTO]
    ) -> [SchemaV2_7_6.AnimeEntryStaff] {
        dtos.enumerated().map {
            SchemaV2_7_6.AnimeEntryStaff(from: $0.element, displayOrder: $0.offset)
        }
    }

    private static func makeEpisodes(
        from dtos: [AnimeEntryEpisodeSummaryDTO]
    ) -> [SchemaV2_7_6.AnimeEntryEpisodeSummary] {
        dtos.enumerated().map {
            SchemaV2_7_6.AnimeEntryEpisodeSummary(from: $0.element, displayOrder: $0.offset)
        }
    }
    ...
    private static func makeEpisodes(
        ...
        payloads.enumerated().map {
            SchemaV2_7_6.AnimeEntryEpisodeSummary(fromLegacy: $0.element, displayOrder: $0.offset)
        }
    }
}
