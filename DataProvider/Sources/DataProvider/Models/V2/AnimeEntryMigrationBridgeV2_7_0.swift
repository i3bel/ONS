//
//  AnimeEntryMigrationBridgeV2_7_0.swift
//  DataProvider
//
...
extension AnimeEntryMigrationWatchStatus {
    init(_ status: SchemaV2_7_0.AnimeEntry.WatchStatus) {
        switch status {
        case .planToWatch:
            self = .planToWatch
        case .watching:
...
extension SchemaV2_7_0.AnimeEntry.WatchStatus {
...
extension SchemaV2_7_0.AnimeEntry {
    convenience init(
        ...
        detail: SchemaV2_7_0.AnimeEntryDetail?,
