//
//  AnimeEntryDetailBridgeV2_7_1.swift
//  DataProvider
//
...
extension SchemaV2_7_1.AnimeEntryDetail {
    public convenience init(from dto: AnimeEntryDetailDTO) {
        self.init(
            ...
            seasons: dto.seasons.map(SchemaV2_7_1.AnimeEntrySeasonSummary.init(from:)),
    ...
    public convenience init(fromLegacy payload: LegacyAnimeEntryDetailPayload) {
        self.init(
            ...
            staff: [],
            seasons: payload.seasons.map(SchemaV2_7_1.AnimeEntrySeasonSummary.init(fromLegacy:)),
    ...
    private func replaceSeasons(with dtos: [AnimeEntrySeasonSummaryDTO]) {
        ...
        seasons = dtos.map(SchemaV2_7_1.AnimeEntrySeasonSummary.init(from:))
    ...
    ) -> [SchemaV2_7_1.AnimeEntryCharacter] {
        dtos.enumerated().map {
            SchemaV2_7_1.AnimeEntryCharacter(from: $0.element, displayOrder: $0.offset)
        }
    }
    ...
    private static func makeCharacters(
        ...
        payloads.enumerated().map {
            SchemaV2_7_1.AnimeEntryCharacter(fromLegacy: $0.element, displayOrder: $0.offset)
        }
    }

    private static func makeStaff(
        from dtos: [AnimeEntryStaffDTO]
    ) -> [SchemaV2_7_1.AnimeEntryStaff] {
        dtos.enumerated().map {
            SchemaV2_7_1.AnimeEntryStaff(from: $0.element, displayOrder: $0.offset)
        }
    }

    private static func makeEpisodes(
        from dtos: [AnimeEntryEpisodeSummaryDTO]
    ) -> [SchemaV2_7_1.AnimeEntryEpisodeSummary] {
        dtos.enumerated().map {
            SchemaV2_7_1.AnimeEntryEpisodeSummary(from: $0.element, displayOrder: $0.offset)
        }
    }
